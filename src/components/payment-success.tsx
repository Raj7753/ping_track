        ...
        {isPending || !isPaymentSuccessful ? (
          ...
          <>
            ...
            <div className='mt-6 flex flex-col items-center gap-1 text-center'>
              <p className='text-lg/7 tracking-tight font-medium text-pretty flex items-center gap-2'>
                Upgrade successful!
                <Icons.celebration className="size-5 text-brand-600" />
              </p>
              <p className='text-gray-600 text-sm/6 text-pretty'>
                Thank you for upgrading to Pro and supporting PingTrack. Your account has been upgraded.
              </p>
            </div>
