...
export const DiscordMessage = ({
  ...
  const IconComponent = titleIcon ? Icons[titleIcon] : null
      ...
      <div className="w-full max-w-xl">
        ...
        <div className="bg-[#2f3136] text-sm w-full rounded p-3 mb-4 mt-1.5">
          <div className="flex flex-row items-center justify-between mb-2">
            ...
            <p className="text-white order-1 text-base/7 font-semibold flex items-center gap-1.5">
              {IconComponent ? (
                <IconComponent className="size-4 text-brand-400" />
              ) : null}
              {title}
            </p>
          </div>
