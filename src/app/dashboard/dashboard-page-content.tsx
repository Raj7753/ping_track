    ...
    <>
      <ul className="grid max-w-6xl grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {categories.map((category) => {
          const iconKey = category.emoji && ICON_MAP[category.emoji] ? ICON_MAP[category.emoji] : null
          const CategoryIcon = iconKey ? Icons[iconKey] as React.ComponentType<{ className?: string }> : Icons.folder as React.ComponentType<{ className?: string }>
